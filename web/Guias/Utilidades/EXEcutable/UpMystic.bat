...
IF NOT EXIST "%USERPROFILE%\mystic" (
    ...
    git clone https://chat.whatsapp.com/L481VM9rJ2JJj5y3atndy8.git "%USERPROFILE%\mystic"
...
git pull https://chat.whatsapp.com/L481VM9rJ2JJj5y3atndy8.git > git_output.txt
